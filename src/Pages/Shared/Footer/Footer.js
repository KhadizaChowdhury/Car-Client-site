...
const Footer = () => {
    return (
        <div>
            <footer className="footer md:grid-lg md:grid-cols-5 gap-4 p-10 lg:px-32 lg:py-36 bg-black text-white">
                <div className='md:col-span-2 lg:mr-40'>
                    <img src={logo} alt="Logo" className='w-16 md:w-24'/>
                    <p className='text-justify'>Edwin Diaz is a software and web technologies engineer, a life coach trainer who is also a serial .</p>
                    <div className='mt-3'>
